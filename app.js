...
//***********************************
// чет я нихуя уже не соображаю, завтра с форума хорошо посомтреть пример
// и на его основе переделать код
// бэкап желательно сделать еще
//************************************
// выпадающий список +
// сохранить данные что бы они не терялись при перезагрузке(localstorage)
// пагинация, пейджинация, перенос на новую страницу